    ...
    @if (auth()->user()->role == 'ADMIN' || auth()->user()->role == 'PERSONALIA')
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <form action="{{ route('search-position') }}" method="GET" class="form-inline ml-auto">
                    @csrf
                    <input class="form-control mr-sm-2" type="search" placeholder="Cari jabatan..." aria-label="Search" name="search" size="12">
