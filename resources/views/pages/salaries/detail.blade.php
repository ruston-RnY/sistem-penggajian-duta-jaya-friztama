                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-stats">
                            ...
                            <div class="trigger">
                                <a href="{{ route('salaries.index') }}" class="btn btn-sm btn-primary">Back</a>
                                <a href="{{ route('cetak-slip-gaji', $salary->id) }}" target="_blank" class="btn btn-info btn-sm ml-2"><i class="fa fa-print"></i> Cetak</a>
                            </div>
                        </div>
                    </div>
                </div>
